        ...
        <GlowCard className="p-5">
          ...
          <div className="mt-5 grid gap-5 lg:grid-cols-3">
            ...
            <label>
              ...
              <select
                disabled
                className="mt-3 h-11 w-full rounded-xl border border-border-subtle bg-surface-2 px-4 font-mono text-text-muted outline-none"
              >
                <option>SoDEX</option>
              </select>
            </label>
              ...
              {showPauseConfirm ? (
                <div className="mt-4 rounded-xl border border-danger/25 bg-danger-dim p-4">
                  ...
                  <div className="mt-4 flex gap-3">
                    ...
                    <PillButton variant="ghost" onClick={() => setShowPauseConfirm(false)}>
                      Cancel
                    </PillButton>
                  </div>
                </div>
