...
export type PortfolioHistoryPoint = {
  // Unix timestamp in MILLISECONDS (JavaScript Date standard)
  // Never seconds. Never ISO string at this layer.
  timestampMs: number;

  // Total portfolio USD value at this timestamp
  // null means data point exists but value could not be resolved
  totalUsdValue: number | null;

  // Source of this data point
  source: "live_snapshot" | "indexed" | "estimated";
};
...
export type PortfolioHistoryResponse = {
  ...
  source: "database" | "computed" | "unavailable";
  error: string | null;
};
